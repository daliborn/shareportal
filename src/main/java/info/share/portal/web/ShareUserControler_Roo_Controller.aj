...
privileged aspect ShareUserControler_Roo_Controller {
    ...
    public String ShareUserControler.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("shareusers", ShareUser.findShareUserEntries(firstResult, sizeNo));
